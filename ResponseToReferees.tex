...
to formally state some of them. E.g., the results on the top of page 3. \Response{The key results from Sections 2.2.1--2.2.3 have been collected in a theorem just before Section 2.2.1.  The key results of Section 3 are also collected into a theorem.}
